    ...
    return (
        <div className=" h-full flex justify-start rounded-xl">
            <div className={" w-1/2  ms-40 h-full flex flex-col"}>
                ...
                <button className={"bg-red-500 w-9/40 h-14 mt-4 mb-8 rounded-xl items-center text-center text-white cursor-pointer duration-150 hover:bg-amber-600 ease-in"}
                onClick={()=> dispatch(toggleAddProductModal(true))}
                >
                    Add Product
                </button>
            </div>
