        ...
        <>
            ...
            <div className={" flex flex-col-2 w-full h-3/55"}>
                <div className={" w-1/10 flex justify-start"}>
                    {clicked === 5 && <div className={`  ${isOpen ? 'w-2/10' : 'w-10/10'} bg-blue-400 w-2/10 rounded-br-3xl rounded-tr-3xl `}></div>}
                </div>
                {isOpen
                    ?
                    <div className={" w-9/10 flex justify-start"}>
                        <div className={`${clicked === 5 ? 'bg-blue-400 ' : 'bg-white'} w-9/10 rounded-lg items-center duration-150 end-auto flex justify-between cursor-pointer`} onClick={() => dispatch(setNumber(5))}>
                            <div className={`${clicked === 5 ? 'invisible' : 'visible'}`}>
                                <Image
                            ...
                            <span className={` me-4 ${clicked === 5 ? 'text-white' : 'text-gray-700'} `}>
                                    Order Lists
                            </span>
