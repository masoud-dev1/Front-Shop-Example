    ...
    <div className=" w-full h-1 flex justify-center mt-30">
      <div className="bg-gray-800 sm:w-16/20 md:h-130 h-110 flex flex-col-2 ">
        <div className=" w-1/2 flex flex-col pl-26 py-16">
          ...
          <h2 className=" text-white md:text-3xl lg:text-4xl 2xl:text-5xl font-semibold pt-6">
            Enhance Your
          </h2>
          <h2 className=" text-white md:text-3xl lg:text-4xl  2xl:text-5xl font-semibold pt-3">
            Music Experience
          </h2>
