...
export default function HomeComponent() {
    return (
        <div className={"bg-stone-950 w-full flex flex-col-3 justify-start  md:justify-center md:h-10 items-center "}>
             ...
             {/*/!*Text Center*!/*/}
             <div className={" w-full md:w-4/10 flex flex-col-2 md:justify-center items-center"}>

                 <span className={"w-5/10 text-white text-nowrap md:text-md text-xs whitespace-normal break-normal"}>Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%! </span>
                 <span className={" w-1/10  text-center text-xs text-nowrap md:text-md text-white font-semibold cursor-pointer"}> ShopNow</span>
